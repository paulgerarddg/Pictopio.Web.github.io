...
namespace Pictopio.Blazor.Server {
    public partial class PictopioBlazorApplication : BlazorApplication {
        public PictopioBlazorApplication() {
            InitializeComponent();
        }
        protected override void OnSetupStarted() {
            ...
            if(configuration.GetConnectionString("ConnectionString") != null) {
                ConnectionString = configuration.GetConnectionString("ConnectionString");
                 //ConnectionString = MySqlConnectionProvider.GetConnectionString("216.127.177.92", "admin", "@Pictopio2022", "PictopioDb"); 
            }
#if EASYTEST
        ...
        private void PictopioBlazorApplication_DatabaseVersionMismatch(object sender, DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
